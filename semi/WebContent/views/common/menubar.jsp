...
<body>
	<div id="menubar" style="width: 1300px; height: 300px;">
		...
		<div id="middlediv"
			...
			<form >
				...
				<div id="searchdiv">
					<input type="text"  class="form-control" placeholder="클래스를 검색해주세요." id="searchinput"	>
					<button type="button"class="btn btn-outline-success" id="searchbtn">검색</button>
				</div> 
		...
		<div id="logindiv">
			...
			<form id="loginform"
				...
				<div id="newmemberdiv" style="background-color: lightgrey;">
					<a id="newMember" href="#">회원가입</a> / <a
						id="findmyid" href="#">아이디</a>, <a id="findmypwd" href="#">비밀번호
						찾기</a>
					...
					<button id="findmypwdbtn" type="button"
						data-toggle="modal" data-target="#findmypwddiv"
			...
			<div id="userdiv">
				...
				<div
					...
					<div >
						...
						나의 등급 : <span id="mydunggul">Pt</span> <!-- 포인트 등급으로 if문처리 -->
						<%}else{%>
						문의개수 : <span id="qna"> 2</span><br>
						승인요청 : <span id="acceptalert">3</span>						
						<% }%>
					</div>
				</div>
				<div id="testinfo"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header" style="width: 100%; background: beige;">
					<h5 class="modal-title" id="staticBackdropLabel"style="margin-left:45%;">회원가입</h5>
				...
				<div class="modal-body" style="width:90%;">
					<form id="insertMemberForm" method="post" onsubmit="return insertcheck();" action='<%=request.getContextPath()%>/insert.me'>
						<div id="signArea">
							...
							<div id="myInterest">
								<input type="checkbox" id="inter1" value="도자기"name="interest"><label for="inter1">도자기</label> <input
									type="checkbox"id="inter2" value="악세서리"name="interest"><label for="inter2">악세서리</label> <input
									type="checkbox"id="inter3" value="가구"name="interest"><label for="inter3">가구</label> <input
									type="checkbox"id="inter4" value="향수"name="interest"><label for="inter4">향수</label> <br> <input
									type="checkbox"id="inter5" value="제과"name="interest"><label for="inter5">제과</label> <input
									type="checkbox"id="inter6" value="원예"name="interest"><label for="inter6">원예</label> <input
									type="checkbox"id="inter7" value="가죽"name="interest"> <label for="inter7">가죽</label> <input
									type="checkbox"id="inter8" value="기타"name="interest"><label for="inter8">기타</label> <br>
							</div>
	...
	<div class="modal fade" id="findmyiddiv" data-backdrop="static"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header" style="width: 100%; background: beige;">
					<h5 class="modal-title" id="staticBackdropLabel" style="margin-left:45%;">ID찾기</h5>
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
