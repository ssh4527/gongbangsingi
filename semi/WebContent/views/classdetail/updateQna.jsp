...
<body>
	...
	<div id="qna4_wrap">
		<br>
		<font class="font_underline"> <u><p class="font"> 문의글 수정하기<br>
				</p></u>
		</font> <br>
		<form action="<%=request.getContextPath()%>/update2.class.qna" name="form" method="post">
			<input type="text" id="Qno" name="Qno" value="<%= q.getqNo() %>" style="display:none;">
			...
			<table class="table table-hover">
				...
				<tr>
					...
					<td><textarea name="title" cols="60" rows="1"
							style="resize: none"><%= q.getqTitle() %><%= q.getqNo() %></textarea></td>
				</tr>
			</table>
			<table class="table table-hover">
				<tr>
				...
				<th>비밀글 설정</th>
					<td>
					<input type="radio" value="Y" name="secret" id="private" <%= ck1 %>> 
					<label for="private" style="cursor:pointer;"> <i class="fas fa-lock"></i></label> &nbsp; 
					<input type="radio" value="N" name="secret" id="public" <%= ck2 %>> 
				...
				<tr>
					...
					<td colspan="5"><textarea name="content" cols="115" rows="10"
							placeholder="내용을 입력해주세요"><%= q.getqContent() %></textarea></td>
				</tr>
			</table>
			<hr>
